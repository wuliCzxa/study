...
private slots:
    ...
    void on_time_label_windowTitleChanged(const QString &title);
    ...
    void on_hideButton2_clicked();
    void on_hideButton1_clicked();
    void on_displayButton2_clicked();
    void on_displayButton1_clicked();
...
private:
    ...
    void initDatabase();
    // 标签切换
    QTimer *m_labelSwitchTimer;
    bool m_showLabel1 = true;
    // --- 串口列表刷新 ---
